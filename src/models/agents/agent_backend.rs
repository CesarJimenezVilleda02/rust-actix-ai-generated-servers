...
mod tests {
    ...
    async fn tests_backend_developer() {
      ...
      {
        "project_description": "build a website that allows students to create todo tasks related to school subjects, include expected time of completion and real time of completion. Then create an endpoint to get all tasks and another to get tasks by subject. Students sgould be able to register and login.",
        "project_scope": {
