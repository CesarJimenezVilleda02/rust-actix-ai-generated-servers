...
pub fn print_improved_webserver_code(_project_description_and_template: &str) {
    ...
    /// IMPORTANT: Print ONLY the code, nothing else. This function ONLY prints code as plain text.
    println!(OUTPUT)
}
...
pub fn print_fixed_code(_broken_code_with_bugs: &str) {
    ...
    /// IMPORTANT: Only prints out the new and improved code. No commentary or anything else. Just code as plain text.
    println!(OUTPUT)
}
