...
pub const CODE_TEMPLATE_PATH: &str =
    "C:/Users/pablo/OneDrive/Documents/Rust/auto_gippity/template/src/template.rs";
pub const EXEC_MAIN_PATH: &str =
    "C:/Users/pablo/OneDrive/Documents/Rust/auto_gippity/template/src/main.rs";
pub const WEB_SERVER_PROJECT_PATH: &str =
    "C:/Users/pablo/OneDrive/Documents/Rust/auto_gippity/template/";
pub const API_SCHEMA_PATH: &str =
    "C:/Users/pablo/OneDrive/Documents/Rust/auto_gippity/schemas/api_schema.json";

pub fn extend_ai_function(ai_function: fn(&str) -> &'static str, func_input: &str) -> Message {
    let ai_function_str = ai_function(func_input);

    // Extend string to encourage only printing output
...
pub async fn ai_task_request(
    ...
    // Get LLM response
    let llm_response_result: Result<String, Box<dyn std::error::Error + Send>> =
    ...
    match llm_response_result {
        ...
        Err(_) => call_gpt(vec![extended_msg.clone()])
            .await
            .expect("Failed to get response twice"),
    }
}
...
mod tests {
    ...
    fn test_extend_ai_function() {
        let extended_msg = extend_ai_function(convert_user_input_to_goal, "dummy desc");
        assert_eq!(extended_msg.role, "system");
    }
